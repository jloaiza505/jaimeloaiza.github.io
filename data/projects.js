const projects = [
  ...
  },
  {
    ...
    result: "PDF report available for download.",
    ready_to_publish: true,
    github: "https://github.com/",
  ...
  {
    id: "ros2-beginner-systems",
    title: "ROS2 Beginner System",
    category: "Robotics & Control",
    summary: "Publisher, subscriber, service, and launch demo for core ROS2 concepts.",
    stack: ["ROS2", "Python", "Launch"],
    result: "Working talker/listener + service toggle with a single launch command.",
    ready_to_publish: true,
    github: "https://github.com/",
    link: "projects/ros2-beginner-systems.html",
    image: ""
  },
  {
